...
void test_calculate_success(void)
{
    ...
    crc8_configuration_t configuration;
    uint8_t crc, lookupTableMemory[256];
...
void test_calculatePartial_success(void)
{
    ...
    crc8_algorithm_t algorithm;
    crc8_configuration_t configuration;
    uint8_t crc, i, lookupTableMemory[256];
...
void test_init_success(void)
{
    ...
    {
        const crc8_algorithm_t Algorithm;
        const crc8_configuration_t ExpectedConfiguration;
        const uint8_t ExpectedLookupTable[256];
    } testData_t;
    ...
    const testData_t TestData[] =
    {
        {
            CRC8_ALGORITHM_CRC8,
            {0xF4, 0x07, 0x00, false, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0xDA, 0x9B, 0xFF, false, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0x15, 0x39, 0x00, true, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0xBC, 0xD5, 0x00, false, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0x97, 0x1D, 0xFF, true, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0x7E, 0x1D, 0xFD, false, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0xA1, 0x07, 0x00, false, 0x55, NULL}, // NULL Not Used
            {
                0x00, 0x07, 0x0E, 0x09, 0x1C, 0x1B, 0x12, 0x15, 0x38, 0x3F, 0x36, 0x31, 0x24, 0x23, 0x2A, 0x2D,
                0x70, 0x77, 0x7E, 0x79, 0x6C, 0x6B, 0x62, 0x65, 0x48, 0x4F, 0x46, 0x41, 0x54, 0x53, 0x5A, 0x5D,
                0xE0, 0xE7, 0xEE, 0xE9, 0xFC, 0xFB, 0xF2, 0xF5, 0xD8, 0xDF, 0xD6, 0xD1, 0xC4, 0xC3, 0xCA, 0xCD,
        ...
        },
        {
            ...
            {0xA1, 0x31, 0x00, true, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0xD0, 0x07, 0xFF, true, 0x00, NULL}, // NULL Not Used
            {
        ...
        },
        {
            ...
            {0x25, 0x9B, 0x00, true, 0x00, NULL}, // NULL Not Used
            {
    ...
    uint8_t i, lookupTableMemory[256];
    size_t j;
    ...
    {
        /* Initialize */
        TEST_ASSERT_EQUAL_INT(ECLECTIC_STATUS_SUCCESS, crc8_init(TestData[i].Algorithm, &actualConfiguration, lookupTableMemory, sizeof(lookupTableMemory)));
        ...
        TEST_ASSERT_EQUAL_HEX8_ARRAY(TestData[i].ExpectedLookupTable, actualConfiguration.lookupTable, 256);
    }
}
